...
export default function BlogDetailsLink({ setActivePage }) {
  ...
  const tocItems = [
    { id: "guest", label: "1. Guest Blogging" },
    { id: "broken", label: "2. Building Broken Links" },
    { id: "resource", label: "3. Links from Resource Pages" },
    { id: "promotion", label: "4. Content Promotion" },
    { id: "outreach", label: "5. Influencer Outreach" },
    { id: "internal", label: "6. Internal Linking" },
    { id: "forums", label: "7. Forums and Communities" },
    { id: "directories", label: "8. Submissions to Directories" },
    { id: "competitor", label: "9. Competitor Analysis" },
    { id: "monitor", label: "10. Analyze and Monitor Backlinks" }
  ]
    ...
    <div className="relative pt-24 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 relative z-10">
        <nav className="flex items-center space-x-2 text-xs sm:text-sm text-slate-600 font-sans font-medium">
          ...
          <FiChevronRight className="text-brand-label" size={14} />
          <span className="text-slate-800 font-semibold truncate">Top 10 Link Building Strategies</span>
        </nav>
      </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 relative z-10 text-left">
        <div className="space-y-6">
          ...
          <h1 className="text-3xl sm:text-6xl font-heading font-extrabold text-slate-900 tracking-tight leading-[1.15] max-w-5xl">
            Top 10 Link Building Strategies to Rank Higher
          </h1>
          ...
          <div className="flex flex-wrap items-center gap-6 text-xs sm:text-sm text-slate-600 font-sans border-b border-slate-100 pb-6">
            <span className="flex items-center gap-1.5"><FiCalendar /> December 27 2023</span>
            <span className="flex items-center gap-1.5"><FiUser /> By TSquadron</span>
            <span className="flex items-center gap-1.5"><FiClock /> 9 min read</span>
          </div>

          <p className="text-lg sm:text-xl text-slate-600 font-sans leading-relaxed max-w-4xl">
            Discover proven link-building strategies that improve domain authority, increase search visibility, and drive long-term organic traffic growth.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10 text-left">
        <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100 shadow-premium max-w-4xl space-y-4">
          <p className="text-slate-700 text-lg font-sans font-medium leading-relaxed">
            “When it comes to search engine optimization, link building plays a major role in improving website rankings on search engine results pages (SERPs).”
          </p>
          <p className="text-slate-600 text-sm sm:text-base font-sans leading-relaxed">
            Securing high-quality backlinks, improving overall domain authority, boosting clean organic traffic channels, raising website SERP positioning, and optimizing search visibility scores are the core levers to establish absolute search ranking dominance.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10 text-left">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-6 space-y-16">
            ...
            {/* Section 1 */}
            <div id="guest" className="space-y-4 scroll-mt-28">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-slate-900 leading-tight">
                1 — Guest Blogging
              </h2>
              <p className="text-slate-600 text-sm sm:text-base font-sans leading-relaxed">
                Writing articles for authoritative niche websites allows brands to secure contextually relevant backlinks, driving massive domain visibility improvements. Creating insightful, highly authoritative resource pieces naturally builds trust, introducing your brand name directly to thousands of potential customers.
              </p>
              
              {/* Guest posting visual widget */}
              <div className="p-6 rounded-2xl bg-slate-50 border border-slate-100 shadow-premium mt-4 space-y-3">
                <span className="text-[10px] text-brand-indigo font-sans uppercase font-bold block">Authority Booster Index</span>
                <div className="flex justify-between items-center bg-white p-3 rounded-lg border border-slate-100 text-xs">
                  <span className="font-semibold">Niche Authority Score</span>
                  <span className="text-brand-indigo font-black">DA 85+</span>
                </div>
              </div>
            </div>

            {/* Section 2 */}
            <div id="broken" className="space-y-4 scroll-mt-28">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-slate-900 leading-tight">
                2 — Building Broken Links
              </h2>
              <p className="text-slate-600 text-sm sm:text-base font-sans leading-relaxed">
                Finding dead resources or broken link opportunities on respected industry websites and suggesting your own active, high-quality article as a replacement is a powerful strategy. This represents a highly collaborative, mutual benefit strategy that webmasters appreciate, generating premium authoritative backlinks effortlessly.
              </p>
            </div>

            {/* Section 3 */}
            <div id="resource" className="space-y-4 scroll-mt-28">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-slate-900 leading-tight">
                3 — Building Links from Resource Pages
              </h2>
              <p className="text-slate-600 text-sm sm:text-base font-sans leading-relaxed">
                Many authority portals organize resource pages containing curated links to valuable guides. Crafting exceptionally deep, helpful guides makes it simple for industry curators to reference your content, yielding valuable, highly reputable backlinks.
              </p>
            </div>

            {/* Section 4 */}
            <div id="promotion" className="space-y-4 scroll-mt-28">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-slate-900 leading-tight">
                4 — Content Promotion
              </h2>
              <p className="text-slate-600 text-sm sm:text-base font-sans leading-relaxed">
                Creating great assets is only half the battle. Actively promoting pages across verified social media outlets, discussion forums, and online communities is key to multiplying your visual reach. Maximizing page visibility naturally sparks independent citation and backlink opportunities.
              </p>
            </div>

            {/* Section 5 */}
            <div id="outreach" className="space-y-4 scroll-mt-28">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-slate-900 leading-tight">
                5 — Influencer Outreach
              </h2>
              <p className="text-slate-600 text-sm sm:text-base font-sans leading-relaxed">
                Establishing direct connections with key thought leaders and influencers opens high-impact co-citation pipelines. When industry experts share, review, or comment positively on your content, it boosts your overall domain reputation and secures authoritative organic links.
              </p>
            </div>

            {/* Section 6 */}
            <div id="internal" className="space-y-4 scroll-mt-28">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-slate-900 leading-tight">
                6 — Internal Linking
              </h2>
              <p className="text-slate-600 text-sm sm:text-base font-sans leading-relaxed">
                Structuring a logical internal linking architecture assists search crawlers in mapping your content hierarchy easily. Passing PageRank efficiently between main parent categories and child posts maximizes the effectiveness of your overall search optimization.
              </p>
            </div>

            {/* Section 7 */}
            <div id="forums" className="space-y-4 scroll-mt-28">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-slate-900 leading-tight">
                7 — Join Forums and Communities
              </h2>
              <p className="text-slate-600 text-sm sm:text-base font-sans leading-relaxed">
                Participating actively in relevant digital discussions on Quora, Reddit, and specialized communities allows you to share helpful answers. Leaving logical context links to deeper resources on your platform targets active buyers, driving valuable, targeted traffic.
              </p>
            </div>

            {/* Section 8 */}
            <div id="directories" className="space-y-4 scroll-mt-28">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-slate-900 leading-tight">
                8 — Submissions to Directories
              </h2>
              <p className="text-slate-600 text-sm sm:text-base font-sans leading-relaxed">
                Registering your corporate platform on reputable, high-trust directories and local business indexes maintains foundational ranking signals. Clear listings build online search consistency, ensuring search bots discover your active corporate citations easily.
              </p>
            </div>

            {/* Section 9 */}
            <div id="competitor" className="space-y-4 scroll-mt-28">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-slate-900 leading-tight">
                9 — Competitor Analysis
              </h2>
              <p className="text-slate-600 text-sm sm:text-base font-sans leading-relaxed">
                Auditing competitor backlink matrices using specialized SEO software highlights their main referral sources. Reverse-engineering their outreach strategies reveals high-probability link building opportunities and authoritative collaboration channels.
              </p>
            </div>

            {/* Section 10 */}
            <div id="monitor" className="space-y-4 scroll-mt-28">
              <h2 className="text-2xl sm:text-3xl font-heading font-bold text-slate-900 leading-tight">
                10 — Analyze and Monitor Backlink Profile
              </h2>
              <p className="text-slate-600 text-sm sm:text-base font-sans leading-relaxed">
                Monitoring your links using enterprise tools like Ahrefs and Google Search Console is critical to maintain clean search parameters. Identifying and disavowing spammy links ensures you preserve strong ranking indicators and grow search traffic safely.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-gradient-to-tr from-brand-indigo/10 to-brand-violet/5 border border-slate-100 shadow-premium space-y-4 text-left my-8">
              ...
              <p className="text-slate-700 text-base sm:text-lg font-sans leading-relaxed">
                “Effective link-building strategies are essential for improving search rankings, increasing visibility, and building long-term online authority.”
              </p>
              <p className="text-slate-600 text-xs font-sans">
                ✓ Connecting strong links with verified content blueprints guarantees maximum brand exposure, stronger authority, and long-term organic traffic.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-slate-50 border border-slate-100/60 shadow-premium space-y-4 text-left my-8">
              ...
              <div className="space-y-3 font-heading font-bold text-sm text-slate-800">
                ...
                <p>“✓ SEO success depends on strong link building.”</p>
                <p>“✓ Content promotion increases visibility.”</p>
                <p>“✓ Internal linking improves SEO structure.”</p>
                <p>“✓ Competitor analysis reveals backlink opportunities.”</p>
              </div>
            </div>
        ...
        <div className="relative rounded-[32px] p-8 sm:p-16 bg-gradient-to-tr from-brand-indigo via-brand-violet to-brand-indigo/90 border border-white/10 overflow-hidden shadow-2xl">
          ...
          <div className="max-w-3xl mx-auto space-y-8 relative z-10">
            ...
            <p className="text-indigo-100 font-sans text-base sm:text-lg max-w-xl mx-auto leading-relaxed">
              Partner with TSquadron to build powerful SEO and link-building strategies that increase visibility, authority, and long-term organic growth.
            </p>
