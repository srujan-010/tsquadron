...
const DEFAULT_SETTINGS = {
  ...
  logoText: "TSquadron",
  contactEmail: "info@tsquadron.in",
...
const DEFAULT_PRODUCTS = [
  {
    ...
    canonicalUrl: "https://www.tsquadron.in/products/digital-marketing-course-warangal/",
  ...
  },
  {
    ...
    canonicalUrl: "https://www.tsquadron.in/products/seo-automation-audit-tool/",
...
const DEFAULT_CLIENTS = [
  {
    ...
    updatedAt: "2026-08-18T08:17:40.236Z"
  },
  {
    id: 2,
    ...
    isActive: true,
    createdAt: "2026-08-18T00:00:00.000Z",
    updatedAt: "2026-08-18T08:17:40.957Z"
  },
  {
    id: 3,
    name: "IMA Warangal",
    ...
    isActive: true,
    createdAt: "2026-08-18T00:00:00.000Z",
    updatedAt: "2026-08-18T08:17:41.769Z"
  },
  {
    id: 4,
    ...
    isActive: true,
    createdAt: "2026-08-18T00:00:00.000Z",
    updatedAt: "2026-08-18T08:17:42.563Z"
  },
  {
    id: 5,
    ...
    isActive: true,
    createdAt: "2026-08-18T00:00:00.000Z",
    updatedAt: "2026-08-18T08:17:43.187Z"
  },
  {
    id: 6,
    name: "Vinayaka Neuro",
    ...
    isActive: true,
    createdAt: "2026-08-18T00:00:00.000Z",
    updatedAt: "2026-08-18T08:17:43.820Z"
  },
  {
    id: 7,
    ...
    isActive: true,
    createdAt: "2026-08-18T00:00:00.000Z",
    updatedAt: "2026-08-18T08:17:44.508Z"
  },
  {
    id: 8,
    ...
    isActive: true,
    createdAt: "2026-08-18T00:00:00.000Z",
    updatedAt: "2026-08-18T08:17:45.216Z"
  },
  {
    id: 9,
    ...
    isActive: true,
    createdAt: "2026-08-18T00:00:00.000Z",
    updatedAt: "2026-08-18T08:17:45.930Z"
  },
  {
    id: 10,
    ...
    isActive: true,
    createdAt: "2026-08-18T00:00:00.000Z",
    updatedAt: "2026-08-18T08:17:46.623Z"
  },
  {
    id: 11,
    ...
    isActive: true,
    createdAt: "2026-08-18T00:00:00.000Z",
    updatedAt: "2026-08-18T08:17:47.415Z"
  },
  {
    id: 12,
    ...
    isActive: true,
    createdAt: "2026-08-18T00:00:00.000Z",
    updatedAt: "2026-08-18T08:17:48.002Z"
  },
  {
    id: 13,
    ...
    isActive: true,
    createdAt: "2026-08-18T00:00:00.000Z",
    updatedAt: "2026-08-18T08:17:48.560Z"
  },
  {
    id: 14,
    name: "Aegesis",
    ...
    isActive: true,
    createdAt: "2026-08-18T00:00:00.000Z",
    updatedAt: "2026-08-18T08:17:49.183Z"
  },
  {
    id: 15,
    name: "Facttax",
    ...
    displayOrder: 15,
    isActive: true,
    createdAt: "2026-08-18T06:24:46.444Z",
    updatedAt: "2026-08-18T08:17:49.831Z"
  }
];
...
export const db = {
  ...
  getClients: () => {
    ...
    DEFAULT_CLIENTS.forEach(defClient => {
      const match = clients.find(c => c.id === defClient.id || (c.name && c.name.toLowerCase() === defClient.name.toLowerCase()));
      if (!match) {
        clients.push(defClient);
        updated = true;
      } else {
        // If match has empty logo or stale base64 and default has valid Cloudinary URL, auto-upgrade
        if ((!match.logoUrl || match.logoUrl.startsWith('data:image/')) && defClient.logoUrl) {
          match.logoUrl = defClient.logoUrl;
          updated = true;
        }
      }
    });
